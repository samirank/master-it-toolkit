window.TOOLKIT_DATA = [
  ...
  },
  {
    ...
    "technicianLicenseNotes": "Use the owner’s account or approved organizational vault. Review business plan and sharing requirements.",
    "portable": false,
    "bootable": false,
    "offline": true,
    "os": [
    ...
    "quickStart": [
      ...
      "Create or sign in to the owner’s vault, choose a strong master passphrase and enable supported multifactor authentication.",
  ...
  },
  {
    ...
    "risk": "CAUTION",
    "caution": "Do not place master passwords, recovery codes, decrypted vault exports or client secrets in toolkit notes or shared download folders.",
    "notes": "Publisher-managed downloads include browser extensions and supported desktop apps. On Linux use a supported browser extension. Review the selected plan’s current limits.",
    "sourceStatus": "Official download and setup documentation reviewed",
    "command": "",
    "defaultFavorite": false,
    "sourceCheckedAt": "2026-09-10",
