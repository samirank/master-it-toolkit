'use strict';
try { document.documentElement.dataset.theme=JSON.parse((localStorage.getItem('neighbor-circuit.v1.preferences')||localStorage.getItem('ventoy.v1.preferences'))||'{}').theme||'dark'; } catch {}
